...
<body>
  <main class="shell">
    ...
    <section class="hero"><div class="intro"><p class="eyebrow">Data statis peserta Sesi 2</p><h2>Denah Tempat Duduk Bus Sesi 2</h2><p>Penataan tempat duduk untuk empat bus pada sesi 2. Nomor kursi (1–36 dan barisan belakang 37–42), posisi pintu, kernet, dan supir 100% presisi sesuai spesifikasi dokumen PDF resmi terbaru (Layout Bus Sesi 2.pdf).</p></div></section>
