...
<div class="max-w-xl mx-auto relative pt-2">
  ...
  <input id="participant-search" type="text" placeholder="Ketik nama peserta untuk mencari..." class="w-full bg-surface-container border border-outline-variant/40 rounded-full py-3 pl-12 pr-12 text-sm text-on-surface placeholder:text-on-surface-variant/60 focus:border-secondary focus:outline-none transition-colors shadow-inner">
